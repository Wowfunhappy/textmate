...
module TextMate
	module Markdown
		...
		def to_html(str, options = { })
			...
			filters << (ENV.has_key?('TM_MARKDOWN') ? '$TM_MARKDOWN' : '"$TM_SUPPORT_PATH/bin/cmark-gfm" --extension table --extension strikethrough --extension autolink --extension tasklist')
